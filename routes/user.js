...
router.get('/mobile',async function (req, res, next) {
  ...
  productHelpers.getMobileProducts().then((mobile)=>{
    console.log(mobile);
    res.render('user/mobile',{mobile,user,cartCount});
  })
});
router.get('/accessories',async function (req, res, next) {
  ...
  productHelpers.getAccessories().then((accessories)=>{
    ...
    res.render('user/accessories',{accessories,user,cartCount});
  })
});
router.get('/mobile-parts',async function (req, res, next) {
  let user = req.session.user
  console.log(user)
  let cartCount = null
  if(req.session.user){
  ...
  productHelpers.getMobileParts().then((parts)=>{
    console.log(parts);
    res.render('user/mobile-parts',{parts,user,cartCount});
  })
});
